...
using Assets.Hyperbyte.BlockPuzzle.Scripts.UI.Utils;
        ...
        void PrepareThemeSelectionScreen()
        {
            ...
            if (currentUITheme != null)
            {
                ...
                foreach (ThemeConfig setting in uiThemeSettings.allThemeConfigs)
                {
                    ...
                    {
                        GetThemeButton(setting, setting.defaultStatus,
                            setting.themeName.Equals(ThemeManager.Instance.GetCurrentThemeName()));
                    }
                }
            }
        }
