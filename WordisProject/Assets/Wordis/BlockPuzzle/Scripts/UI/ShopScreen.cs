...
using Assets.Wordis.Frameworks.UnityIAP.Scripts;
using UnityEngine;
...
#pragma warning restore 0649
        ...
        {
            txtWatchVideoReward.text = string.Format(LocalizationManager.Instance.GetTextWithTag("txtGems_FR"),
                ProfileManager.Instance.GetAppSettings().watchVideoRewardAmount);
            ...
            if (ProfileManager.Instance.IsAppAdFree())
            {
                ...
                mainContentRect.sizeDelta = new Vector2(currentContentSize.x,
                    currentContentSize.y - btnRemoveAds.GetComponent<RectTransform>().sizeDelta.y);
            }
            else
            {
