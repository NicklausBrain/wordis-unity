namespace Assets.Wordis.BlockPuzzle.GameCore.Functions.Dictionary.English
{
    ...
    /// </summary>
    public class EngDictionaryA : DictionaryBase
    {
...
Apotome (n.) The difference between two quantities commensurable only in power, as between �2 and 1, or between the diagonal and side of a square.
