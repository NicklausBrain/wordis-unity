...
namespace Assets.Wordis.Frameworks.ThemeManager.Editor
{
    ...
    public class UIThemeSettingsEditor : CustomInspectorHelper
    {
        ...
        void CreateNewTheme()
        {
            string assetPath = $"Assets/{nameof(Wordis)}/Resources/UIThemes";
            string folderPath = $"{Application.dataPath}/{nameof(Wordis)}/Resources/UIThemes";
