...
namespace Assets.Wordis.Frameworks.ThemeManager.Scripts.Utils
{
    /// <summary>
    /// Attach this script to any UI Image type to associalte it with sprite tag.
    /// </summary>
    [RequireComponent(typeof(Image))]
    public class ImageSpriteTag : MonoBehaviour
    {
        Image thisImage;
...
#pragma warning restore 0649
        ...
        private void UpdateUI()
        {
            if (thisImage)
            {
                thisImage.SetSpriteWithThemeId(spriteTag);
            }
        }
    }
}