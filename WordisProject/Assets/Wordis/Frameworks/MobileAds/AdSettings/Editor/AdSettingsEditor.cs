...
using Assets.Wordis.Frameworks._Common.Editor;
using Assets.Wordis.Frameworks.MobileAds.AdSettings.Scripts;
using Assets.Wordis.Frameworks.MobileAds.AppLovinMax.Scripts;
using Assets.Wordis.Frameworks.MobileAds.GoogleMobileAds.Scripts;
using Assets.Wordis.Frameworks.MobileAds.IronSource.Scripts;
using Assets.Wordis.Frameworks.MobileAds.UnityAds.Scripts;
using Assets.Wordis.Frameworks.Utils;
using UnityEditor;
using UnityEngine;

namespace Assets.Wordis.Frameworks.MobileAds.AdSettings.Editor
{
    ...
    public class AdSettingsEditor : CustomInspectorHelper
    {
        ...
        {
            string assetPath = $"Assets/{nameof(Wordis)}/Resources/AdNetworkSettings";
            string assetName = "";
            ...
            switch (selection)
            {
                case AdNetworkSelection.UnityAds:
                    ...
                    {
                        unityAdsAsset = (UnityAdsSettings)Resources.Load(
                            $"AdNetworkSettings/{System.IO.Path.GetFileNameWithoutExtension(assetName)}");
                    }
                    else
                    {
