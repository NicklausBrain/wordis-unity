...
namespace Assets.Wordis.Frameworks.MobileAds.UnityAds.Scripts
{
    /// <summary>
 ...
 Monetization.GetPlacementContent(settings.GetInterstitialPlacement()) as ShowAdPlacementContent;
            ad.Show(options);
#endif
        }
        ...
        void RequestRewarded()
        {
            ...
            ShowAdPlacementContent ad =
 Monetization.GetPlacementContent(settings.GetRewardedPlacement()) as ShowAdPlacementContent;
            ad.Show(options);
#endif
        }
