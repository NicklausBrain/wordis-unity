...
namespace Assets.Wordis.Frameworks.Utils
{
    /// <summary>
    ...
    public static class StringUtil
    {
        ...
        public static string GetRandomCharacterString(int stringLength)
        {
            ...
            {
                randomScrabbledString = string.Concat(randomScrabbledString,
                    characterSet[UnityEngine.Random.Range(0, characterSetLength)]);
            }
