...
namespace Assets.Wordis.Frameworks.UITween.Scripts.TweenTypes
{
    ...
    /// Canvas Group Tween.
    /// </summary>
    public class HBCanvasGroupAlpha : MonoBehaviour
    {
        ...
        public HBCanvasGroupAlpha SetDelay(float _delay)
        {
            delay = _delay;
            return this;
        }
        ...
        public HBCanvasGroupAlpha SetEase(Ease ease)
        {
            easeType = ease;
            return this;
        }
        ...
        public HBCanvasGroupAlpha SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong)
        {
        ...
        public HBCanvasGroupAlpha SetAnimation(AnimationCurve curve)
        {
        ...
        public HBCanvasGroupAlpha OnComplete(Action onComplete)
        {
        ...
        public HBCanvasGroupAlpha OnLoopComplete(Action<int> onLoopComplete)
        {
