...
namespace Assets.Wordis.Frameworks.UITween.Scripts.TweenTypes
{
    /// <summary>
    /// Text Tween.
    /// </summary>
    public class HBTextAlpha : MonoBehaviour
    {
        Color defaultColor;
        ...
        public HBTextAlpha SetDelay(float _delay)
        {
            delay = _delay;
            return this;
        }
        ...
        public HBTextAlpha SetEase(Ease ease)
        {
            easeType = ease;
            return this;
        }
        ...
        public HBTextAlpha SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong)
        {
        ...
        public HBTextAlpha SetAnimation(AnimationCurve curve)
        {
        ...
        public HBTextAlpha OnComplete(Action onComplete)
        {
        ...
        public HBTextAlpha OnLoopComplete(Action<int> onLoopComplete)
        {
        ...
        {
            thisText.color = new Color(defaultColor.r, defaultColor.g, defaultColor.b, val);
        }
