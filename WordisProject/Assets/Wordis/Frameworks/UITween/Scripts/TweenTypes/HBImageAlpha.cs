...
namespace Assets.Wordis.Frameworks.UITween.Scripts.TweenTypes
{
    ...
    /// Image Tween.
    /// </summary>
    public class HBImageAlpha : MonoBehaviour
    {
        Color defaultColor;
        ...
        public HBImageAlpha SetDelay(float _delay)
        {
            delay = _delay;
            return this;
        }
        ...
        public HBImageAlpha SetEase(Ease ease)
        {
            easeType = ease;
            return this;
        }
        ...
        public HBImageAlpha SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong)
        {
        ...
        public HBImageAlpha SetAnimation(AnimationCurve curve)
        {
        ...
        public HBImageAlpha OnComplete(Action onComplete)
        {
        ...
        public HBImageAlpha OnLoopComplete(Action<int> onLoopComplete)
        {
